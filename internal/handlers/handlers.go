...
// Layout holds the layout template for date which is 2020-01-01 -- 01/02 03:04:05PM '06 -0700
...
`, reservation.Room.RoomName, reservation.StartDate.Format("2006-01-02"), reservation.EndDate.Format("2006-01-02"))
	...
	htmlMessage = fmt.Sprintf(`
		...
		Dear Admin, <br><br>
		This is to notification of reservation from %s for <b>%s</b> to %s.`,
	...
	msg = models.MailData{
		...
		Subject: "Reservation Confirmation from " + reservation.FirstName,
		Content: htmlMessage,
	}
